...
for z in range(0, int(loopCountZ)):
    # Front Side
    gcodeList.append("G1 X" + str(xPos + (xDistancePerStep * xStepsPerEStep * loopCountX)) + " E" + str(eDistancePerStep * loopCountX))
    
    # Right Side
    gcodeList.append("G1 Y" + str(yPos + (yDistancePerStep * yStepsPerEStep * loopCountY)) + " E" + str(eDistancePerStep * loopCountY))
        
    # Back Side
    gcodeList.append("G1 X" + str(xPos) + " E" + str(eDistancePerStep * loopCountX))
    
    # Left Side
    gcodeList.append("G1 Y" + str(yPos) + " E" + str(eDistancePerStep * loopCountY))
